...
let
  ...
  cfg = config.${namespace}.services.desktop.window-managers.aerospace;
in
{
  options.${namespace}.services.desktop.window-managers.aerospace = {
  ...
  config = mkIf cfg.enable {
    ...
    home.file.".config/aerospace/aerospace.toml".text = aerospaceConfig;
  };
}
